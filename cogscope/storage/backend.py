...
logger = logging.getLogger("cogscope.storage.backend")
...
class StorageConfig:
    ...
    db_path: str = "~/.cogscope/cogscope.db"  # for DuckDB
...
class PostgresBackend(StorageBackend):
    ...
    Requires psycopg2: pip install cogscope[postgres]
    """
    ...
    def __init__(self, config: StorageConfig):
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install cogscope[postgres]"
            )
    ...
    def get_trace(self, trace_id: str) -> ReasoningTrace:
        from cogscope.core.exceptions import TraceNotFoundError
    ...
    def get_fingerprint(self, fingerprint_id: str) -> BehavioralFingerprint:
        from cogscope.core.exceptions import StorageError
